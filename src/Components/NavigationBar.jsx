            ...
            <Router>
                <nav className="navbar navbar-expand-lg p-2 mainNav shadow sticky-top bg-white">
                    <div className="container-fluid">
                        ...
                        <Link className="nav-link " activeClassName="active-nav" aria-current="page" to="/"><img src={Logo_text1}  className='nav-imgt1'/></Link>
                        ...
                        <div className="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul className="navbar-nav me-auto mb-2 mb-lg-0 mx-auto mobileNav">
                                <li className="nav-item mainNavitem">
                                    <Link className="nav-link fw-semibold" activeClassName="active-nav" aria-current="page" to="/">Home</Link>
                                </li>
