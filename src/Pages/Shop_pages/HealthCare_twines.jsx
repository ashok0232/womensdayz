...
import { allProducts, healthCare } from "../../Data/Products_data";
...
export default function HealCare_twines(params) {
    ...
    const HealthCare_data = allProducts.map((item) => {
        ...
        return item.category === 'health_care' ? (
            <div className="col-sm-3 col-6 product-mobile" key={item.id}>
                <Products
                    name={item.name}
                    price={item.price}
                    img={item.img}
        ...
        <>
           ...
           <div className="container">
            ...
            <div className="text-center mt-5 p-2">
                <button className="p-2 buttons" style={{ width: '16%', height: '21%' }}> <img src={load} /> Load More </button>
            </div>
